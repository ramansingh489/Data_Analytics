...
# create partition on this sheet 
# partition by range
# partition by hash
# partition by list
...
select * from ineuron_partition.ineuron_course where course_lauch_year=2020;
...
course_launch_year int)
partition by hash(course_launch_year)
partitions 10;     # how it will divided the partitions - partition by reminder 2019/10 = 9
...
select * from ineuron_partition.ineuron_courses8;
...
select * from ineuron_partition.ineuron_courses9;
