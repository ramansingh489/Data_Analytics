...
# check the total count of the records
select count(*) from bank_details;
-- ----------------------------------------------------------------------------------------------------------------------------------------

# fetch out limited columns as per the requirement
select age, loan, job from bank_details;
-- ----------------------------------------------------------------------------------------------------------------------------------------

# select default from bank_details;   -- it will show an error becuase default is a reserver keywords and we cannot take the reserved keywords
select `default` from bank_details;
-- ----------------------------------------------------------------------------------------------------------------------------------------

# fetch out only 5 records from the data
select * from bank_details limit 5;
-- ----------------------------------------------------------------------------------------------------------------------------------------

# fetch out those records whoes age is 33
select * from bank_details where age = 33;
-- ----------------------------------------------------------------------------------------------------------------------------------------

# fetch out those records whoes age is equal to and greater than 60
...
# using OR logical operator, fetch out those records whose education is unkown or marital is single
select * from bank_details where education = 'unkown' or marital = 'single';
-- ----------------------------------------------------------------------------------------------------------------------------------------

# using OR AND logical operator, fetch out those records whose education is unkown or marital is single and balance is greater than > 500
select * from bank_details where balance >= 500 and (education = 'unkown' or marital = 'single');
-- ----------------------------------------------------------------------------------------------------------------------------------------


# types of jobs in the dataset -- using distinct
select distinct job from bank_details;
-- ----------------------------------------------------------------------------------------------------------------------------------------

# fetch out all the records as per age wise ascending -- using order by
select * from bank_details order by age;       -- by default order by using ascending order
